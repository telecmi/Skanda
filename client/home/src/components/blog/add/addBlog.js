...
class Page extends Component {
    ...
    submit = () => {
        ...
        if (validationSub.Meta && validationSub.OG && validationSub.Twitter && validationSub.Article && validationSub.URL && validationSub.category && validationSub.author && validationSub.introduction_section && validationSub.Section && validationSub.FAQ && validationSub.recommended_reading && validationSub.Testimonial) {
            ...
            axiosInstance.post('/blogAdd', formData, progress).then((res) => {
    ...
    preview = () => {
        ...
        let blogIntro = {
            "img": this.state.blog_intro_img_preview,
            "img_alt": this.state.blog_intro_img_alt,
            "description": this.state.blog_intro_desc,
            "blog_title": this.state.blog_intro_title
        }
                            ...
                            <div className=" gap-x-8 gap-y-6 ">
                                ...
                                <div>
                                    ...
                                    <div className='flex flex-col ring-1 gap-y-4 p-3 rounded-lg'>
                                        ...
                                        <input onChange={(e) => this.blog_intro_img_alt(e.target.value)} placeholder='ALT Text' type="text" className='block w-full rounded-md  px-3.5 py-2 text-gray-900 bg-white ring-1 border-none' />
                                    </div>
                                </div>
                                                                            ...
                                                                            section.type === 'testimonials' ?
                                                                                <div className=' ring-slate-400 rounded-md'>
                                                                                    <div className='flex flex-col gap-y-3'>
                                                                                        ...
                                                                                        <input accept='.webp, .png' type='file' onChange={(e) => this.updateTestiImg(e, secData.id)} className={`block w-full rounded-md text-sm px-3.5 py-2 text-gray-900 bg-white ring-1 border-none`} />
                                                                                                        ...
                                                                                                        secData.title === 'table' ?
                                                                                                            ...
                                                                                                            secData.title === 'button' ?
                                                                                                                <div className='flex flex-col ring-1 gap-y-4 p-3 pt-5 rounded-lg'>
                                                                                                                    <input onChange={(e) => this.updateSecData(e.target.value, secData)} value={secData.alt} placeholder='Button Content' type="text" className='block w-full rounded-md  px-3.5 py-2 text-gray-900 bg-white ring-1 border-none' />
                                                                                                                    <input onChange={(e) => this.updateSecButData(e, secData)} value={secData.alt} placeholder='Button Link' type="text" className='block w-full rounded-md  px-3.5 py-2 text-gray-900 bg-white ring-1 border-none' />
                                                                                                                </div> :
